...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `sanduler`, `repo_name`, `twitter_handle`, `linkedin_username`, `email`, `email_client`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/sanduler/repo_name.git
   ```
...
See the [open issues](https://github.com/sanduler/repo_name/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/sanduler/repo_name](https://github.com/sanduler/repo_name)
